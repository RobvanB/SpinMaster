...
RSpec.describe "spin_headers/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit spin_header form" do
    render

    assert_select "form[action=?][method=?]", spin_header_path(@spin_header), "post" do
